...
void setup () {
  Serial.begin(9600);
  mySerial.begin(9600);
  mySerial.println("OMSC Software Serial");
...
void Print() {
  ...
  mySerial.println("SUCCESSFULLY SET!");
  mySerial.print("ON TIME- ");
  mySerial.print(hr_on);
  mySerial.print(":");
  mySerial.print(mn_on);

  mySerial.println();

  mySerial.print("OFF TIME- ");
  mySerial.print(hr_off);
  mySerial.print(":");
  mySerial.print(mn_off);
